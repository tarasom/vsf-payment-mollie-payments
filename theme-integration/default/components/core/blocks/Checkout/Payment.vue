    ...
    <div class="row pl20" v-if="isActive">
      ...
      <div class="col-xs-11 col-sm-9 col-md-10">
        <div class="row" v-if="isActive">
          ...
          <div v-for="(method, index) in molliePaymentMethods" :key="index" class="col-md-6">
            <label class="radioStyled">
              <span class="payment-method-icon">
                <img :src="getPaymentIcon(method.code)" :alt="method.title ? method.title : method.name">
              </span>
...
import iDealIssuers from 'src/modules/vsf-payment-getnoticed-mollie/components/iDealIssuers'
...
export default {
  ...
  computed: {
    ...
    molliePaymentMethods () {
      return pickBy(this.paymentMethods, (paymentMethod) => { return (paymentMethod.mollieMethod) })
    },
    isIdeal () {
